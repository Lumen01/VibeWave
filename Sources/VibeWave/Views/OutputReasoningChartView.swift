...
public struct OutputReasoningChartView: View {
    ...
    public var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            VStack(alignment: .leading, spacing: 0) {
                ChartHeaderView(title: "Output + Reasoning", mode: $mode)
    ...
    private func chartView(layout: XAxisLayout, plottedData: [OutputReasoningDataPoint]) -> some View {
